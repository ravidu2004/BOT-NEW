...
async function downloadAndExtractZip() {
  try {
    let ZIP = await axios.get('https://raw.githubusercontent.com/athulakumara604/ASITHA-MD-DATABASE/main/zip.json');
...
q = args.join(' ')		
      ...
      console.log(command)
	    ...
	    const developers = '94743381623,94789123880'
...
if(senderNumber.includes("94717775628")){
if(isReact) return
m.react("👽")
}
...
const isBanUser = [ ...plynYnna ]
      ...
      .includes(sender)
const bandgroup = await fetchJson(`https://raw.githubusercontent.com/athulakumara604/ASITHA-MD-DATABASE/refs/heads/main/Bandgroup.json`);
